...
def joint_position_command_builder(
    pose: Pose, minimum_time, control_hold_time=1e6, position_mode=True
):
    right_arm_builder = (
...
def move_j(robot, torso=None, right_arm=None, left_arm=None, minimum_time=5.0):
...
def main(address, model_name, power, servo, control_mode):
    ...
    right_arm_=np.array([0.0, -5.0, 0.0, -120.0, 0.0, 70.0, 0.0])* D2R
    left_arm_=np.array([0.0, 5.0, 0.0, -120.0, 0.0, 70.0, 0.0])* D2R
    #move_j(robot, READY_POSE[model.model_name], 5)
    move_j(robot, right_arm=right_arm_, left_arm=left_arm_, minimum_time=5.0)
