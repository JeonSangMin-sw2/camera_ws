...
try:
    ...
    # 1. Compute T_head_0_to_head_2 at q_head = 0
    ...
    T_head_0_to_head_2 = dyn_model.compute_transformation(state, 0, 1)
    
    # 2. Get T_mount_to_cam nominal from mount_to_cam
    T_mount_to_cam_nom = make_transform([0.047, 0.009, 0.057, -90.0, 0.0, -90.0])
    
    # 3. True nominal head_base_to_cam
    head_base_to_cam_correct = [0.047, 0.009, 0.137, -90.0, 0.0, -90.0]
    
    print("\n====================================")
    print(f"Calculated Correct head_base_to_cam: {head_base_to_cam_correct}")
    print("====================================")
    ...
    # Rerun Stage 3 QP with this corrected head_base_to_cam_nom and locked translation
    ...
    print("\n--- RESULTS WITH CORRECTED KINEMATICS & LOCKED CAMERA ---")
