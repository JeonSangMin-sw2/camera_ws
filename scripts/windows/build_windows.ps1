...
# 4. PyInstaller Build
Write-Host "[4/4] Building Windows Standalone Executable with PyInstaller..." -ForegroundColor Yellow
pyinstaller --clean --noconfirm camera_calibrator.spec

Write-Host "`n===================================================" -ForegroundColor Green
Write-Host "   Build Complete! (Windows)                     " -ForegroundColor Green
Write-Host "   Output files located in: .\dist\             " -ForegroundColor Green
